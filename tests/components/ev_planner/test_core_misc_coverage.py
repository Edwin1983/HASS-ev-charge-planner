...
from homeassistant.components.ev_planner.core.models import ChargingPlan, Hour
from homeassistant.components.ev_planner.core.planner import EVPlanner, PlannerSettings
